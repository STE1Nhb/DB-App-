namespace DBApp.Migrations
{
    ...
    public partial class InitialDb : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        subcriber_id = c.Int(nullable: false),
                        type_id = c.Int(nullable: false),
                        subscription_price = c.Single(nullable: false),
                        purchase_date = c.DateTime(nullable: false),
                    })
                .PrimaryKey(t => t.purchase_id)
                .ForeignKey("dbo.subscribers_subscriptions", t => new { t.subcriber_id, t.type_id }, cascadeDelete: true)
                .ForeignKey("dbo.subscription_prices", t => t.type_id, cascadeDelete: true)
                .Index(t => new { t.subcriber_id, t.type_id });
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.purchase_confirmations", new[] { "subcriber_id", "type_id" }, "dbo.subscribers_subscriptions");
            ...
            DropIndex("dbo.purchase_confirmations", new[] { "subcriber_id", "type_id" });
